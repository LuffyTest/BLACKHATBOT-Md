...
▶ Views: ${json.info[0].playCount} 
❤ Likes: ${json.info[0].diggCount} 
🔁 Shares: ${json.info[0].shareCount} 
💬 Comments: ${json.info[0].commentCount} 
🎵 Music Name: ${json.info[0].musicMeta.musicName} by ${json.info[0].musicMeta.musicAuthor}
